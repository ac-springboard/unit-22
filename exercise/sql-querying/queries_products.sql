...
insert into products (name, price, can_be_returned) values ('Fresh Elon Musk''s Snot', 1000000.00, true);
...
select * from products where price between 22.50 and 99.99; -- or
...
update products set can_be_returned = true where not can_be_returned;
